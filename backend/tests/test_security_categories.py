...
def test_security_category_aliases_normalize():
    ...
    assert normalize_category("eval-injection") == "code-injection"
    ...
    assert normalize_category("version-not-pinned") == "dependency-version-range"
    assert normalize_category("deprecated-dependency") == "dependency-deprecated"
